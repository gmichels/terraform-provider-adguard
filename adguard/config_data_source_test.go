		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.adguard_config.test", "querylog.ignored_enabled", "true"),
					...
					resource.TestCheckResourceAttr("data.adguard_config.test", "stats.ignored_enabled", "true"),
					...
					resource.TestCheckResourceAttr("data.adguard_config.test", "rewrites", "true"),
