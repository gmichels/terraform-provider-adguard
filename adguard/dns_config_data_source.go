...
func (d *dnsConfigDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		DeprecationMessage: "The `adguard_dns_config` data source is deprecated and will be removed in a future release. Use the `dns_config` block in the `adguard_config` data source instead.",
