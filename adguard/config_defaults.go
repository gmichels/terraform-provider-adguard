...
const CONFIG_QUERYLOG_IGNORED_ENABLED = true
const CONFIG_STATS_ENABLED = true
const CONFIG_STATS_INTERVAL = 24 // hours
const CONFIG_STATS_IGNORED_ENABLED = true
...
const CONFIG_DNS_CACHE_ENABLED = true
...
const CONFIG_DNS_UPSTREAM_TIMEOUT = 10
...
const CONFIG_REWRITES_ENABLED = true
